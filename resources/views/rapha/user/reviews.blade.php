      ...
      <div class="review_container mt-4">
        <div class="review_actions action_{{ $review->id }}">
          <div class="text-center">
           <a href="{{ route('show-edit-review') }}" class="url"><h6>Edit Review</h6></a>
        </div>
        <div class="text-center">
          <a href="{{ route('show-edit-review') }}" class="text-danger"><h6>Delete Review</h6></a>
        </div>
        </div>

          <div class="row justify-content-center align-items-center">
            <div class="col-6 col-sm-3 col-md-2">
              <img src="{{ asset('images/' . $review->rating->rating_photo ) }}" alt="rating" class="img-fluid">
            </div>
        
            <div class="col-2 col-sm-1">
          
              <img src="{{ asset('images/dots.png') }}" alt="" class="img-fluid" data-id="{{ $review->id }}" id="review_action_toggle">
