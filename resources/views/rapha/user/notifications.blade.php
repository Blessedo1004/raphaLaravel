        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="d-flex justify-content-center align-items-center mb-3">
                    <h2>Notifications</h2>
                    <a href="{{ route('user-mark-all-as-read') }}" class="btn reg_btn text-white col-4 col-xl-3 @if($notificationsCount<1) disabled @endif">Mark all as read</a>
                </div>
                  ...
                  <div class="col-12 col-lg-10 bg-light mt-2">
                    ...
                    <ul class="list-group">
                        @foreach ($notificationsOnDate as $notification)
                            <li class="list-group-item d-flex justify-content-center align-items-center flex-column @if(!$notification->read_at) bg-light @endif">
