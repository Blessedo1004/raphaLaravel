  ...
  <x-slot name="body">
    ...
    <div class="notice_container">
      ...
      <form action="{{ route('edit-review',$review->id) }}" method="post">
        ...
        <div>
           <textarea name="content" id="review-content" class="mx-auto d-block col-12 col-sm-8 col-md-7 text-center mt-4" placeholder="Talk About Your Experience" rows="8" maxlength="250">{{old('content',$review->content) }}</textarea>
