<x-head title="Rapha Hotel — Exclusive Room" metaDescription="Check into our Exclusive Rooms, where beauty is seasoned with comfort. We are located at the State Secretariat environ, which is easily accessible from the city centre. Come and have your relaxation without the usual hustle and bustle.">
...
<section id="subheader" class="relative jarallax text-light">
    <img src="{{asset('images/room-exclusive/1.webp')}}" class="jarallax-img" alt="">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                ...
                <ul class="crumb">
                    ...
                    <li class="active">Exclusive Room</li>
                </ul>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                <h3 class="wow fadeInUp">Check into our Exclusive Rooms, where beauty is seasoned with comfort. We are located at the State Secretariat environ, which is easily accessible from the city centre. Come and have your relaxation without the usual hustle and bustle.</h3>
            </div>
        </div>
    </div>
        ...
        <div class="owl-custom-nav menu-float" data-target="#room-carousel">
            ...
            <div id="room-carousel" class="owl-2-cols-center owl-carousel owl-theme">
                ...
                <div class="item">
                    ...
                    <img src="{{ asset('images/room-exclusive/1.webp') }}" class="w-100" alt="">
                </div>
                </div>
                <!-- room end -->
                ...
                <div class="item">
                    <div class="hover relative text-light">
                        <img src="{{ asset('images/room-exclusive/2.webp') }}" class="w-100" alt="">
                    </div>
                </div>
                <!-- room end -->
                ...
                <div class="item">
                    <div class="hover relative text-light">
                        <img src="{{ asset('images/room-exclusive/4.webp') }}" class="w-100" alt="">
                    </div>
                </div>
                <!-- room end -->
                ...
                <div class="item">
                    ...
                    <div class="hover relative text-light">
                        <img src="{{ asset('images/room-exclusive/3.webp') }}" class="w-100" alt="">
                    </div>
                </div>
                <!-- room end -->
            </div>
