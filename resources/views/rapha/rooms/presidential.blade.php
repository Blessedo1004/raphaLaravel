<x-head title="Rapha Hotel — Presidential Suite" metaDescription="Check into our Presidential Suite, where prestige is wrapped in elegance and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and savour unalloyed relaxation devoid of the usual hustle and bustle.">
    <x-slot name="body">
        <!-- content begin -->
        <div class="no-bottom no-top" id="content">
            ...
            <section id="subheader" class="relative jarallax text-light">
                <img src="{{asset('images/room/R1.webp')}}" class="jarallax-img" alt="">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12 text-center">
                            ...
                            <ul class="crumb">
                                ...
                                <li class="active">Presidential Suite</li>
                            </ul>
                                    ...
                                    <div class="col-md-6 text-center">
                                        <div class="text-light p-4 h-100 wow fadeInRight" data-bgcolor="#70533A" data-wow-delay=".2s">
                                            <div class="de_count fs-15 wow fadeInRight" data-wow-delay=".6s">
                                                <a class="btn-main btn-line no-bg mt-lg-4" href="{{ route('make-reservation', $room->id) }}">Book Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="relative">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-7 text-center">
                            <h3 class="wow fadeInUp">Check into our Presidential Suite, where prestige is wrapped in elegance and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and savour unalloyed relaxation devoid of the usual hustle and bustle.</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="room-carousel" class="owl-2-cols-center owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room/R2.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room-presidential/F1.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room-presidential/F2.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room/R1.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                        </div>
                ...
                <div class="container">
            <div class="row g-4 justify-content-center offset-md-2 offset-lg-0">
                ...
                <!-- <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        <img src="images/icons/size.png" class="w-40px" alt="">
                ...
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        <img src="{{asset('images/icons/bed.png')}}" class="w-40px" alt="">
                ...
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        <img src="{{asset('images/icons/tv.png')}}" class="w-40px" alt="">
                ...
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        <img src="{{asset('images/icons/shower.png')}}" class="w-40px" alt="">
                ...
                <!-- <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        <img src="images/icons/wifi.png" class="w-40px" alt="">
                ...
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        <img src="{{asset('images/icons/desk.png')}}" class="w-40px" alt="">
                ...
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        <img src="{{asset('images/icons/bathub.png')}}" class="w-40px" alt="">
...
<!-- 
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        <img src="images/icons/city.png" class="w-40px" alt="">
        ...
        <div class="container-fluid relative z-2">
            <div class="row g-4">
                ...
                <div class="col-lg-12">
                    ...
                    <x-banquet-conference></x-banquet-conference>
