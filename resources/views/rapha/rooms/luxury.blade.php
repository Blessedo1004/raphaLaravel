<x-head title="Rapha Hotel — Luxury Room" metaDescription="Check into Premier Rooms, where class is immersed in comeliness and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and catch the fun you have been cut off from due to the usual hustle and bustle.">
  <x-slot name="body">
<!-- content begin -->
<div class="no-bottom no-top" id="content">
    ...
    <section id="subheader" class="relative jarallax text-light">
        <img src="{{asset('images/room-luxury/F1.webp')}}" class="jarallax-img" alt="">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    ...
                    <ul class="crumb">
                        ...
                        <li class="active">Luxury Room</li>
                    </ul>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 text-center">
                    <h3 class="wow fadeInUp">Check into our Luxury Rooms, where luxury is married with sophistication and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and catch the aesthetics and nature devoid of the usual hustle and bustle.</h3>
                </div>
            </div>
        </div>
                ...
                <div id="room-carousel" class="owl-2-cols-center owl-carousel owl-theme">
                    ...
                    <div class="item">
                        <div class="hover relative text-light">
                            <img src="{{asset('images/room-luxury/F2.webp')}}" class="w-100" alt="">
                        </div>
                    </div>
                    <!-- room end -->
                    ...
                    <div class="item">
                        <div class="hover relative text-light">
                            <img src="{{asset('images/room-luxury/F3.webp')}}" class="w-100" alt="">
                        </div>
                    </div>
                    <!-- room end -->
                    ...
                    <div class="item">
                        <div class="hover relative text-light">
                            <img src="{{asset('images/room/T1.webp')}}" class="w-100" alt="">
                        </div>
                    </div>
                    <!-- room end -->
                    ...
                    <div class="item">
                        <div class="hover relative text-light">
                            <img src="{{asset('images/room-luxury/F1.webp')}}" class="w-100" alt="">
                        </div>
                    </div>
                    <!-- room end -->
                </div>
