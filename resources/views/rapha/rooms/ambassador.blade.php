<x-head title="Rapha Hotel — Ambassador Suite" metaDescription="Check into our Ambassador Suite, where prestige is engrossed in comeliness and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and enjoy the rich hospitality endeared by the serene environment devoid of the usual hustle and bustle.">
    <x-slot name="body">
          <!-- content begin -->
        <div class="no-bottom no-top" id="content">
            ...
            <section id="subheader" class="relative jarallax text-light">
                <img src="{{asset('images/room-ambassador/2.webp')}}" class="jarallax-img" alt="">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12 text-center">
                            ...
                            <ul class="crumb">
                                ...
                                <li class="active">Ambassador Suite</li>
                            </ul>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-7 text-center">
                            <h3 class="wow fadeInUp">Check into our Ambassador Suite, where prestige is engrossed in comeliness and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and enjoy the rich hospitality endeared by the serene environment devoid of the usual hustle and bustle.</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="room-carousel" class="owl-2-cols-center owl-carousel owl-theme">
                            ...
                            <div class="item">
                              <div class="hover relative text-light">
                                <img src="{{asset('images/room-ambassador/1.webp')}}" class="w-100" alt="">
                            </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room-ambassador/3.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room-ambassador/4.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                ...
                                <div class="hover relative text-light">
                                  <img src="{{asset('images/room-ambassador/5.webp')}}" class="w-100" alt="">
                              </div>
                            </div>
                            <!-- room end -->
                        </div>
