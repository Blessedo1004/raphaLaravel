<x-head title="Rapha Hotel — Family Room" metaDescription=">Check into our Family Rooms, where comeliness is cuddled in unity and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and enjoy the serene atmosphere devoid of the usual hustle and bustle.">
    <x-slot name="body">
        <!-- content begin -->
        <div class="no-bottom no-top" id="content">
            ...
            <section id="subheader" class="relative jarallax text-light">
                <img src="{{asset('images/room/R6.webp')}}" class="jarallax-img" alt="">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-7 text-center">
                            <h3 class="wow fadeInUp">Check into our Family Rooms, where comeliness is cuddled in unity and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and enjoy the serene atmosphere devoid of the usual hustle and bustle.</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="room-carousel" class="owl-2-cols-center owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room-family/F1.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room/R6.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                        </div>
