<x-head title="Rapha Hotel — SuperStudio Room" metaDescription="Experience comfort and convenience in our Super Studio Rooms. Perfect for solo travelers or couples, our Super Studio Rooms offer a serene environment to relax and unwind.">
...
<x-slot name="body">
  ...
  <div class="no-bottom no-top" id="content">
      ...
      <section id="subheader" class="relative jarallax text-light">
          <img src="{{ asset('images/room-superstudio/1.webp') }}" class="jarallax-img" alt="">
          <div class="container relative z-index-1000">
              <div class="row justify-content-center">
                  <div class="col-lg-12 text-center">
                      <h1>Super Studio Room</h1>
                      <ul class="crumb">
                          <li><a href="{{ route('rapha.home') }}">Home</a></li>
                          <li class="active">Super Studio Room</li>
                      </ul>
          ...
          <div class="container">
              <div class="row justify-content-center">
                  <div class="col-lg-7 text-center">
                      <h3 class="wow fadeInUp">Check into our Super Studio Rooms, where standard is combined with comfort. We are located at the State Secretariat environ, easily accessible from the city centre. Come and enjoy our serene environment, free from the usual hustle and bustle.</h3>
                  </div>
              </div>
          </div>
                  ...
                  <div id="room-carousel" class="owl-2-cols-center owl-carousel owl-theme">
                      ...
                      <div class="item">
                        <div class="hover relative text-light">
                          <img src="{{asset('images/room-superstudio/1.webp')}}" class="w-100" alt="">
                      </div>
                      </div>
                      <!-- room end -->
                      ...
                      <div class="item">
                          <div class="hover relative text-light">
                              <img src="{{asset('images/room-superstudio/2.webp')}}" class="w-100" alt="">
                          </div>
                      </div>
                      <!-- room end -->
                      ...
                      <div class="item">
                          <div class="hover relative text-light">
                              <img src="{{asset('images/room-superstudio/3.webp')}}" class="w-100" alt="">
                          </div>
                      </div>
                      <!-- room end -->
                      ...
                      <div class="item">
                          ...
                          <div class="hover relative text-light">
                            <img src="{{asset('images/room-superstudio/5.webp')}}" class="w-100" alt="">
                        </div>
                      </div>
                      <!-- room end -->
                  </div>
