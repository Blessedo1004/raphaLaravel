     ...
     <!-- content begin -->
        <div class="no-bottom no-top" id="content">
            ...
            <section id="subheader" class="relative jarallax text-light">
                <img src="{{asset('images/room/SL2.webp')}}" class="jarallax-img" alt="">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-7 text-center">
                            <h3 class="wow fadeInUp">Check into our 2 Bedrooms Duplex Apartment, where you will experience real home from home experience and comfort. We are located at the State Secretariat environ which is easily accessible from the city. Come and savour true relaxation in complete privacy, devoid of the usual hustle and bustle.</h3>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="room-carousel" class="owl-2-cols-center owl-carousel owl-theme">
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room/SL3.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room/SL2.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room/SL12.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                            ...
                            <div class="item">
                                <div class="hover relative text-light">
                                    <img src="{{asset('images/room/SL4.webp')}}" class="w-100" alt="">
                                </div>
                            </div>
                            <!-- room end -->
                        </div>
            ...
            <div class="row g-4 justify-content-center offset-md-2 offset-lg-0">
                <div class="col-lg-3 col-6 wow fadeInRight" data-wow-delay=".2s">
                    <div class="d-block relative">
                        ...
                        <p class="absolute abs-middle ml70 text-dark fw-500">6 Guests</p>
                    </div>
                </div>
